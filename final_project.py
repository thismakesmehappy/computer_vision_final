        ...
        while True:
            ...
            for row in range (self.rows):
                for column in range(self.columns):
                    ...
                    origin_y, origin_x, middle_x, middle_y = self.calculate_image_size_and_place(width, height, row, column)
                    self.draw_random_shape(canvas, width, height, origin_y, origin_x, middle_x, middle_y, fill_color=color)
            break
